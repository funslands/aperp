...
interface IMarkets {
    ...
    event LiquidatedPosition(bytes32 indexed marketId, address indexed taker, bool indexed direction, int256 margin, int256 amount, int256 value, int256 tradeFee, int256 pnl, int256 liquidationFee, int256 fundingPayment);
